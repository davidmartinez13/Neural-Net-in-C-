...
namespace matrix
{
    ...
    // class representing a simple densely connected neural network
    ...
    class SimpleNeuralNetwork
    {
        ...
        public:
            ...
            vector<Matrix2D<float>> _weightMatrices;
            vector<Matrix2D<float>> _valueMatrices;
            vector<Matrix2D<float>> _biasMatrices;
            float _learningRate;
